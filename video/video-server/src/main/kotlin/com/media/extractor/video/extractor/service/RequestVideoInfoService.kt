...
class RequestVideoInfoService {
    ...
    fun requestVideoInfo(vid: String): VideoUrlInfoRes {
        if (vid.startsWith("wxv")) {
            ...
            videoApiUrl1 = builder.toUriString()
            var rawRes = restTemplate.getForEntity<VideoUrlInfoRawRes>(videoApiUrl1, VideoUrlInfoRawRes::class.java)
            ...
            var builder = UriComponentsBuilder.fromHttpUrl(videoApiUrl2)
                    ...
                    .queryParam("fmt", "auto")
                    .queryParam("defsrc", "1")
            videoApiUrl2 = builder.toUriString()
            var rawRes = restTemplate.getForEntity(videoApiUrl2, String::class.java)
